            ...
            >
                ...
                <div style={{ flex: 1, textAlign: 'center' }}>
                    <div style={{ fontSize: '14px', fontWeight: 'bold', textTransform: 'uppercase', letterSpacing: '1px' }}>
                        {header.titulo || 'Desinfeccion de Reservorios'}
                    </div>
                    {totalPages > 1 && (
...
export default function DesinfeccionReservoriosApp() {
    ...
    const handleExport = useCallback(async () => {
        ...
        try {
            ...
            const blob = await postBlob('/api/desinfeccion-reservorios/render-pdf', formData, HTTP_TIMEOUTS.EXPORT);
            const url = URL.createObjectURL(blob);
            const a = document.createElement('a');
            a.href = url;
            a.download = 'desinfeccion_reservorios.pdf';
